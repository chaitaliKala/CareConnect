...
if($_GET['id'])
{
$update = mysqli_query($conn,"select * from patientcheckup where
patientId='".$_GET['id']."'") or die(mysqli_error($conn));
...
?>
    ...
    <form id="patientForm" method="post" action="updateform.php">
